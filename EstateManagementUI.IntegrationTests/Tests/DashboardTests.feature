...
@PRTest
Scenario: Login and Dashboard Navigation Test
	...
	And the dashboard displays the navigation menu
...
Scenario: Dashboard Display After Login
	...
	And the dashboard shows estate information
