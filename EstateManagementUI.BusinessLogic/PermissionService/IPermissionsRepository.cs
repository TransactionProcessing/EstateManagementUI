...
public interface IPermissionsRepository {
    ...
    Task<Result<Role>> GetRole(String roleName, CancellationToken cancellationToken);
    ...
    Task<Result<Int32>> AddRole(String roleName, CancellationToken cancellationToken);

    Task<List<String>> GetTableList(CancellationToken cancellationToken);
}