...
public static class APIModelFactory {
    ...
    public static MerchantModels.MerchantScheduleModel ConvertFrom(BackendAPI.DataTransferObjects.MerchantScheduleResponse apiResult)
    {
    ...
    public static MerchantModels.MerchantOpeningHoursModel ConvertFrom(List<MerchantOpeningHour> apiResultData) {
        MerchantModels.MerchantOpeningHoursModel model = new();
        foreach (MerchantOpeningHour merchantOpeningHour in apiResultData) {
            AssignOpeningHours(model, merchantOpeningHour.DayOfWeek, new MerchantModels.DayOpeningHoursModel() { Opening = merchantOpeningHour.OpeningTime, Closing = merchantOpeningHour.ClosingTime });
        }
