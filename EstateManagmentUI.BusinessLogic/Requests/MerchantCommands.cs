...
using MediatR;
using SimpleResults;
using static EstateManagementUI.BusinessLogic.Requests.MerchantCommands;
...
public static class MerchantCommands {
    ...
    public record UpdateMerchantOpeningHoursCommand(CorrelationId CorrelationId, Guid EstateId, Guid MerchantId, MerchantOpeningHours OpeningHours) : IRequest<Result>;
