...
public class MediatorRegistry : ServiceRegistry {
    ...
    private void RegisterMerchantRequestHandler() {
        ...
        this.AddSingleton<IRequestHandler<Commands.AssignDeviceToMerchantCommand, Result>, MerchantRequestHandler>();
    }
    ...
    private void RegisterContractRequestHandler() {
        ...
        this.AddSingleton<IRequestHandler<Commands.CreateContractProductTransactionFeeCommand, Result>, ContractRequestHandler>();
    }
